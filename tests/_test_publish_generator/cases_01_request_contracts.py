...
def test_publish_html_blocks_without_a_hash_bound_readiness_artifact(
    publish_settings_factory,
    run_context,
    wordpress_http,
) -> None:
    ...
    assert outcome.validation_issues == ["publish_readiness.missing"]
    assert (
...
def test_publish_html_does_not_bypass_missing_readiness_for_script_content(
    publish_settings_factory,
    run_context,
    wordpress_http,
) -> None:
...
def test_publish_html_warn_policy_still_blocks_missing_canonical_readiness(
    publish_settings_factory,
    run_context,
    wordpress_http,
) -> None:
