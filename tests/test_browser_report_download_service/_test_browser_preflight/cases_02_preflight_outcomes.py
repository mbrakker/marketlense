...
def test_browser_preflight_recognizes_terminal_access_forbidden_page() -> None:
    assert preflight_runtime._is_terminal_access_forbidden_page(
        title="403 Forbidden",
        html=("<html><body><h1>Error 403 Forbidden</h1><p>Forbidden</p></body></html>"),
    )
...
def test_download_report_with_browser_use_uses_forced_preflight_for_http_access_status(
    ...
    external_boundary_mocks_only.setattr(
        ...
        lambda module_name: (_ for _ in ()).throw(
            AssertionError(
                "full browser-use Agent should not load after terminal preflight"
            )
        ),
    )
...
def test_download_report_with_browser_use_blocks_terminal_access_forbidden_preflight(
    ...
    assert (
        ...
        in response.terminal_evidence.evidence_labels
    )
    assert_no_defaulted_required_fields(response)
...
def test_browser_preflight_confirms_js_rendered_pdf_without_full_agent(
    ...
    assert (
        "preflight_reuse_state_available" in response.terminal_evidence.evidence_labels
    )
    assert_no_defaulted_required_fields(response)
    events = [
...
def test_browser_preflight_rejects_title_mismatched_pdf_candidate(
    ...
    page_url = (
        "https://example.com/insights/food-and-drink/global-food-and-drink-trends"
    )
    unrelated_pdf_url = (
        "https://assets.example.com/Mintel_Gender_Pay_Gap_Report_2025.pdf"
    )
    runtime = _runtime(
        tmp_path,
        route_kind="pdf_download",
...
__all__ = [
    "test_browser_preflight_contract_round_trip",
    "test_browser_preflight_recognizes_terminal_not_found_page",
    "test_browser_preflight_waits_for_redirected_terminal_not_found_page",
    "test_browser_preflight_recognizes_terminal_access_forbidden_page",
    "test_browser_preflight_skips_email_route_without_positive_evidence",
    "test_browser_preflight_runs_for_email_route_when_http_access_signal_requires_it",
    "test_browser_preflight_uses_standard_browser_user_agent",
    "test_download_report_with_browser_use_uses_forced_preflight_for_http_access_status",
    "test_download_report_with_browser_use_blocks_terminal_access_forbidden_preflight",
    "test_browser_preflight_confirms_js_rendered_pdf_without_full_agent",
    "test_browser_preflight_escalates_cleanly_when_evidence_is_insufficient",
    "test_browser_preflight_escalation_reuses_the_open_browser_session",
    "test_async_unverified_deterministic_submit_preserves_preflight_browser_for_agent",
    "test_browser_preflight_rejects_rendered_legal_pdf_candidate",
    "test_browser_preflight_rejects_title_mismatched_pdf_candidate",
]
