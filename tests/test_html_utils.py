...
class TestHtmlUtils(unittest.TestCase):
    ...
    def test_strip_publication_internal_metadata_removes_operator_identifiers(self) -> None:
        html = (
            '<script data-market-lense-publish-entity="true">'
            '{"source_artifact_id":"report:internal-1"}</script>'
            '<p hidden>Drive fileId: report:internal-1</p>Drive fileId: report:internal-2'
            '<footer class="footer">Generated by Market Lense. File ID: '
            '<code>report:internal-1</code>.</footer><p>Public summary.</p>'
        )

        rendered = strip_publication_internal_metadata(html)

        self.assertEqual(rendered, "<p>Public summary.</p>")
