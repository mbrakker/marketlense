        ...
        def openai_chat_json(self, request, ctx):
            ...
            payload = {
                "summary": {
                    ...
                    "card_tldr_compact": (
                        "U.K. experts prioritise digital video and display."
                    ),
                    "executive_summary": (
                        "U.K. media experts prioritise digital video and display "
                        "over the next 12 months."
                    ...
                    "claim_evidence_map": [
                        {
                            "claim": (
                                "U.K. media experts prioritise digital video and "
                                "display over the next 12 months."
                            ),
                            "evidence_id": "finding-2",
                            "evidence": (
                                "Digital video and display lead the stated priorities."
                            ),
                            "evidence_spans": [],
                            "pages": [6],
                        }
...
__all__ = [
    ...
    "test_ias_summary_with_uk_provenance_is_accepted_on_primary_response",
