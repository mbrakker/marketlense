...
def test_ci_workflow_archives_fresh_release_evidence_bundle() -> None:
    ...
    accounting_index = workflow.index("Reconcile retained canonical LLM accounting corpus")
    ...
    assert trend_index < health_index < accounting_index < manifest_index < review_index < upload_index
