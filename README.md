...
- Browser downloads also write one row per successful local PDF download into `paths.reports_db` table `report_sources`, storing `source_domain`, `report_name`, `landing_page_url`, `downloaded_at_utc`, and the downloaded file `md5`.
