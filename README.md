...
- Typed candidate features: extracted table/chart candidates now carry a versioned `CandidateFeatures` contract used by ranking, crop-refine prompts, and deterministic prefilters; legacy candidate metadata remains as a compatibility projection.
