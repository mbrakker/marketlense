...
- Figure quality gate: candidate visuals now pass deterministic prefilters plus LLM thresholds (overall + quality + insight + data), adaptive GPT crop refinement, and strict final cropping (up to 5 visuals). If none pass, the figure section is hidden.
