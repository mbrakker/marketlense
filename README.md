...
- PDF dependency security baseline: the application and vendored browser-use manifests require `pypdf 6.12.0`, closing the current malformed cross-reference and layout-mode resource-exhaustion advisories.
