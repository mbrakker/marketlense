...
def _config_load_complete_fields(
    ...
    *,
    ...
    return {
        ...
        "crop_qa_escalation_enabled": settings.crop_qa_escalation_enabled,
        "crop_qa_escalation_min_score": settings.crop_qa_escalation_min_score,
        "crop_qa_escalation_max_score": settings.crop_qa_escalation_max_score,
        "crop_qa_escalation_max_calls": settings.crop_qa_escalation_max_calls,
        "crop_qa_escalation_max_repairs": settings.crop_qa_escalation_max_repairs,
...
def load_settings(request: ConfigLoadRequest, ctx: RunContext) -> AppSettings:
    ...
    settings = AppSettings(
        ...
        crop_qa_escalation_enabled=rank_settings["crop_qa_escalation_enabled"],
        crop_qa_escalation_min_score=rank_settings["crop_qa_escalation_min_score"],
        crop_qa_escalation_max_score=rank_settings["crop_qa_escalation_max_score"],
        crop_qa_escalation_max_calls=rank_settings["crop_qa_escalation_max_calls"],
        crop_qa_escalation_max_repairs=rank_settings["crop_qa_escalation_max_repairs"],
