...
current page through the same consent preflight and action-level postconditions;
the normal route budget and final verification still govern the terminal outcome.
