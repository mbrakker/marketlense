...
class VectorStoreMetadata:
    ...
    region: str = field(default="", metadata={"doc": "Primary region/market focus for the report."})
...
class VectorStoreCreateRequest:
    ...
    metadata: VectorStoreMetadata = field(metadata={"doc": "Metadata to attach to the vector store."})
...
class VectorStoreStatusRequest:
    schema_version: str = field(metadata={"doc": "Vector store status request schema version."})
...
class VectorStoreUpdateMetadataRequest:
    ...
    metadata: VectorStoreMetadata = field(metadata={"doc": "Updated metadata for the vector store."})


@dataclass(frozen=True)
class VectorStoreUpdateMetadataResponse:
    schema_version: str = field(metadata={"doc": "Vector store metadata update response schema version."})
    vector_store_id: str = field(metadata={"doc": "Vector store identifier that was updated."})
