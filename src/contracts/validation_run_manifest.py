...
class ValidationRunManifestCreateRequest(SemanticIdContract):
    schema_version: str = field(metadata={"doc": "Manifest create request schema version."})
    db_path: str
...
class ValidationRunManifestStageRecord(SemanticIdContract):
    schema_version: str = field(metadata={"doc": "Manifest stage record schema version."})
    validation_run_id: ValidationRunId
    workflow_run_id: RunId
    entity_type: str
    publisher_id: str
...
class ValidationRunManifestRecordRequest:
    schema_version: str = field(metadata={"doc": "Manifest record request schema version."})
    db_path: str
...
class ValidationRunManifestRecordResponse:
    schema_version: str = field(metadata={"doc": "Manifest record response schema version."})
    stage_record_id: str
    inserted: bool
...
class ValidationRunManifestAuditRequest(SemanticIdContract):
    schema_version: str = field(metadata={"doc": "Manifest audit request schema version."})
    db_path: str
    validation_run_id: ValidationRunId
...
class ValidationRunManifestStageTotal:
    schema_version: str = field(metadata={"doc": "Manifest stage total schema version."})
    stage: str
    terminal_outcome: str
    entity_count: int
...
class ValidationRunManifestAuditResponse(SemanticIdContract):
    schema_version: str = field(metadata={"doc": "Manifest audit response schema version."})
    validation_run_id: ValidationRunId
    complete: bool
