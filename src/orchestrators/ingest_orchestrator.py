...
def _process_file(
    ...
    def _result(outcome: IngestOutcome, processed: int = 0, had_error: bool = False) -> _FileProcessResult:
        return _FileProcessResult(index=index, outcome=outcome, processed=processed, had_error=had_error)
