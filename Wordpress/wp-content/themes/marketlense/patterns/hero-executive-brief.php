<?php
/**
 * Title: ML - Hero: Executive Brief
 * Slug: marketlense/hero-executive-brief
  ...
  <div class="wp-block-group ml-hero-frame">
    ...
    <div class="wp-block-group ml-hero-content">
      ...
      <div class="wp-block-group ml-hero-stack">
        ...
        <h1 class="wp-block-heading ml-hero-title has-4-xl-font-size">From source report to executive brief, with claims you can trace.</h1>
        <!-- /wp:heading -->
