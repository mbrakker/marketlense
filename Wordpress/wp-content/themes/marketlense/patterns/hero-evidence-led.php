  ...
  <div class="wp-block-group ml-hero-frame">
    ...
    <div class="wp-block-group ml-hero-content">
      ...
      <div class="wp-block-group ml-hero-stack">
        ...
        <h1 class="wp-block-heading ml-hero-title has-4-xl-font-size">Validated market reports for leaders who need evidence, not noise.</h1>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"className":"ml-hero-copy"} -->
        <p class="ml-hero-copy">Browse a disciplined archive of report briefs spanning macro outlooks, sector shifts, consumer behavior, and technology adoption.</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-buttons ml-hero-actions">
          ...
          <div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button ml-button" href="<?php echo esc_url(home_url('/topics-directory/')); ?>">Explore topics</a></div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
      </div>
