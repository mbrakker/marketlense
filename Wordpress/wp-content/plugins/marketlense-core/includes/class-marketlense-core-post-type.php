        ...
        register_post_type(
            ...
            [
                'labels' => [
                    ...
                    'menu_name'             => __('Market Bearing Reports', 'marketlense-core'),
                ],
                'public'              => true,
                'show_ui'             => true,
                'show_in_menu'        => true,
        ...
        register_post_type(
            ...
            [
                'labels' => [
                    ...
                    'menu_name'          => __('Market Bearing Signals', 'marketlense-core'),
                ],
                'public'              => true,
                'show_ui'             => true,
                'show_in_menu'        => true,
        ...
        register_post_type(
            ...
            [
                'labels' => [
                    ...
                    'set_featured_image'    => __('Set cover image', 'marketlense-core'),
                    'remove_featured_image' => __('Remove cover image', 'marketlense-core'),
                    'menu_name'             => __('Market Bearing Briefings', 'marketlense-core'),
                ],
                'public'              => true,
                'show_ui'             => true,
                'show_in_menu'        => true,
