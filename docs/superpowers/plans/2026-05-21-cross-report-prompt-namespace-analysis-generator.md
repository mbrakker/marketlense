...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task. This archived plan records step order only; active backlog tracking belongs in `CONSOLIDATED_TODO.md`.
