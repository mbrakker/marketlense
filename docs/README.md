...
| [Operations](ops/local-development.md) | Current setup, configuration, credentials, deployment, monitoring, recovery, troubleshooting, WordPress operations, source-publication metadata, budget authority, and remediation/runbook coverage. Associated YAML files are machine-readable operational policy and coverage inputs. |
