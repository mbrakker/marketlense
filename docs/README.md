...
| [Quality](quality/testing.md) | Current testing, release-gate, benchmark, architecture-policy, public-editorial-quality, non-regression, and evidence procedures, including the [E13 repair benchmark](quality/e13-repair-benchmark/README.md). YAML and JSON files in this directory are the enforced policy, allowlist, baseline, schema, and quality-ledger inputs; dated reviews and proposals are historical context. |
