...
- Architect: [architecture overview](architecture/overview.md), [workflow control](architecture/workflow-control.md), [external boundaries](architecture/external-system-boundaries.md), and the machine-enforced [architecture policy](quality/architecture-policy.md).
