...
| Source publication metadata or template | Rendered HTML and downstream publication | Render only |
...
reports migration 17. It stores deterministic plan identity and both planned
and observed work without altering checkpoint storage.
