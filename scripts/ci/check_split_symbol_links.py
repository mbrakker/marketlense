...
BOUNDARY_EXPORT_REQUIREMENTS: dict[str, tuple[str, ...]] = {
    ...
    "src/orchestrators/_report_analysis_orchestrator/artifact_batches.py": (
        "ArtifactTaskRenderer",
        "_artifact_batch_workers",
        "_execute_artifact_step_batch",
    ),
    "src/orchestrators/_report_analysis_orchestrator/vector_store.py": (
    ...
    "src/orchestrators/_report_analysis_orchestrator/payload.py": (
        "REPORT_PAYLOAD_SENTINELS",
        "_attach_payload_analysis_metadata",
        "_serialize_context_category_fit_payload",
        "_ensure_report_payload_complete",
    ),
    "src/orchestrators/_report_analysis_orchestrator/validation.py": (
        "_run_validation_regeneration_loop",
        "_run_validation_with_fallback",
        "_store_validation_snapshot",
    ),
    "src/orchestrators/_report_analysis_orchestrator/regeneration_plan.py": (
        "RULE_ID_RE",
        "TARGET_ORDER",
        "BROAD_TARGETS",
        "_build_regeneration_plan",
    ...
    "src/generators/publisher_inventory_candidate_screening_generator.py": (
    ...
    "src/generators/_publisher_inventory_candidate_screening/shared.py": (
    ...
    "src/generators/_publisher_inventory_candidate_screening/deterministic.py": (
    ...
    "src/generators/_publisher_inventory_candidate_screening/response_policy.py": (
    ...
    "src/generators/_publisher_inventory_candidate_screening/llm_batches.py": (
