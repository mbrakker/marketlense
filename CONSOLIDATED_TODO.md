...
| Closed | D10 | Browser executor, static DOM scan, and prompt-payload reduction | Publisher-specific, fully postcondition-verified playbooks now execute before Browser Use through the canonical headless worker; any drift falls through to the existing Agent route. Live Brand Finance validation on 2026-08-16 captured the verified on-site artifact with 0 Browser Use model calls. |
