...
| Deferred | D10 | Browser executor, static DOM scan, and prompt-payload reduction | Revisit when route telemetry identifies a measurable cost/latency gap not covered by A5. |
